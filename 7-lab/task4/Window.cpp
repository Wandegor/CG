...
void Window::OnRunStart()
{
    ...
    m_quad = std::make_unique<RenderObject>(quadVertices, quadIndices, 5);

    // glDisable(GL_DEPTH_TEST);

    m_textures.push_back(LoadTexture("Textures/scala.jpg"));
    m_textures.push_back(LoadTexture("Textures/wall6.jpg"));
}
...
void Window::Draw(int width, int height)
{
    ...
    float progress = (sin(currentTime) + 1.0f) / 2.0f;
    m_shader->SetFloat("uProgress", progress);
